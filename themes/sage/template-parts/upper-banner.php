...
<div class="upper-banner" style="background:linear-gradient( rgba(<?php echo $Final_Rgb_Img_Overlay_color;  ?>,0.7), rgba(<?php echo $Final_Rgb_Img_Overlay_color;  ?>,0.7)), url(<?php echo get_field("banner_image") ?>)no-repeat center; background-size:cover">
