...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6  entrepeneur events" id="post-<?php the_ID(); ?>" <?php post_class('blogpost-entry'); ?> style="background:url(<?php the_post_thumbnail_url("large") ?> )top right !important ; background-size:contain !important;"">
	...
	<?php 
		...
		echo "<div class='date'><h1>".$test->format("d")."</h1>";
